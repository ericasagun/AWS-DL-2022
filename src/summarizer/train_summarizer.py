...
model.from_pretrained(
    model_type="t5", model_name="t5-base"
)  # model_name options: t5-small, t5-large, t5-3b, t5-11b
...
random_convos = random.sample(
    list(valid_df["source_text"]), 3
)  # sample 3 random convos
